...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    address private BDSRefAddress = 0x000000000000000000000000000000000000dEaD;
    ...
    function _farm() internal virtual {
        ...
        if (isCAKEStaking) {
            ...
            IPancakeswapFarm(farmContractAddress).deposit(pid, wantAmt, BDSRefAddress);
        }
    }
    ...
    function updateBDSRefAddress(address _refAddress) public onlyAllowGov {
        BDSRefAddress = _refAddress;
    }
...
// File: contracts/StratX2_BDS.sol
...
contract StratX2_BDS is StratX2 {
    constructor(
